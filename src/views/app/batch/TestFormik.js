...
// import { doGetBatchRequest, doEditBatchStatusRequest, doAddReviewBatchRequest} from '../../../redux-saga/actions/Batch'
// import { doGetBatchStudentRequest } from '../../../redux-saga/actions/BatchStudent'
// import { doGetUsernameRequest } from '../../../redux-saga/actions/Ufo'
...
// const batch_status = ['new','running', 'stop']
...
//                                                             <img className="block h-7 w-7 rounded-full ring-2 ring-white" src={`${config.domain}/batch/images/${taba.taba_tale.tale_photo}`} />
