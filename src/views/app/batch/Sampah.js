                    ...
                    list && list.map(isi => {
                        return (
                            ...
                            <div class='m-10 inline-flex'>
                                ...
                                <div class="p-5">
                                    <a href="#">
                                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-black">{isi.user_first_name} {isi.user_last_name}</h5>
                                    </a>
                                <div>
